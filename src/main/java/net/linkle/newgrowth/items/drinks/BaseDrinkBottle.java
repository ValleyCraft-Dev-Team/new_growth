...
public class BaseDrinkBottle extends BaseFood {

    public BaseDrinkBottle(Settings settings, int hunger, float satMod) {
        super(settings, hunger, satMod);
    }
    
    public BaseDrinkBottle(Settings settings, int hunger, float satMod, FoodStatusEffect effects) {
