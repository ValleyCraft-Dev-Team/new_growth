...
public class BaseFood extends Item {
    ...
    public BaseFood(Settings settings) {
        super(settings);
    }

    /** @param satMod = saturationModifier */
    public BaseFood(Settings settings, int hunger, float satMod) {
        this(settings, hunger, satMod, false);
    }
    
    /** @param satMod = saturationModifier */
    public BaseFood(Settings settings, int hunger, float satMod, boolean isMeat) {
        this(settings, hunger, satMod, isMeat, null);
    }
    
    /** @param satMod = saturationModifier */
    public BaseFood(Settings settings, int hunger, float satMod, @Nullable FoodStatusEffect effects) {
        this(settings, hunger, satMod, false, effects);
    }
    
    /** @param satMod = saturationModifier */
    public BaseFood(Settings settings, int hunger, float satMod, boolean isMeat, @Nullable FoodStatusEffect effects) {
